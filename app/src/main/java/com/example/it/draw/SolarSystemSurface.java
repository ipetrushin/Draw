...
public class SolarSystemSurface extends SurfaceView implements SurfaceHolder.Callback {
    int counter = 0;
    DrawThread dt;
    ...
    public SolarSystemSurface (Context context, AttributeSet attributeSet)
    {
